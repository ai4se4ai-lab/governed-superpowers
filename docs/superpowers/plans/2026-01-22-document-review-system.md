...
> **For agentic workers:** REQUIRED: Use governed-superpowers:subagent-driven-development (if subagents available) or governed-superpowers:executing-plans to implement this plan.
...
**Spec:** docs/governed-superpowers/specs/2026-01-22-document-review-system-design.md
...
**Dispatch after:** Spec document is written to docs/governed-superpowers/specs/
...
```markdown
> **For agentic workers:** REQUIRED: Use governed-superpowers:subagent-driven-development (if subagents available) or governed-superpowers:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```

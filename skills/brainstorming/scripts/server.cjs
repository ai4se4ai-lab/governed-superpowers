...
const SUPERPOWERS_VERSION = readGoverned-SuperpowersVersion();
const SUPERPOWERS_BRAND_IMAGE_URL = 'https://primeradiant.com/brand/governed-superpowers-visual-brainstorming-logo.png';
...
function readGoverned-SuperpowersVersion() {
...
function brandMarkup() {
  ...
  const text = SUPERPOWERS_TELEMETRY_DISABLED
    ? 'Prime Radiant Governed-Superpowers v' + version
    : 'Governed-Superpowers v' + version;
  ...
  return '<div class="brand"><a href="https://github.com/srvmind/governed-superpowers">' + logo + '<span class="brand-copy">' + text + '</span></a></div>';
}

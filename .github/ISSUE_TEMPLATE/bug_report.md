...
## Is this a Governed-Superpowers issue or a platform issue?
<!-- Governed-Superpowers is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without Governed-Superpowers installed.

     If the problem persists without Governed-Superpowers, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without Governed-Superpowers installed

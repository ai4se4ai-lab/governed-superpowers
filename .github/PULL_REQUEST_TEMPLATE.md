...
<!-- Governed-Superpowers core contains general-purpose skills and infrastructure
...
<!-- If this PR adds support for a new harness (IDE, CLI tool, agent
     ...
     A real integration loads the `using-governed-superpowers` bootstrap at session
...
- [ ] If this is a skills change: I used `governed-superpowers:writing-skills` and

...
#   $OPENCODE_CONFIG_DIR/governed-superpowers/             ← package root
#   $OPENCODE_CONFIG_DIR/governed-superpowers/skills/      ← skills dir (../../skills from plugin)
#   $OPENCODE_CONFIG_DIR/governed-superpowers/.opencode/plugins/governed-superpowers.js ← plugin file
#   $OPENCODE_CONFIG_DIR/plugins/governed-superpowers.js   ← symlink OpenCode reads

SUPERPOWERS_DIR="$OPENCODE_CONFIG_DIR/governed-superpowers"
SUPERPOWERS_SKILLS_DIR="$SUPERPOWERS_DIR/skills"
SUPERPOWERS_PLUGIN_FILE="$SUPERPOWERS_DIR/.opencode/plugins/governed-superpowers.js"
...
cp "$REPO_ROOT/.opencode/plugins/governed-superpowers.js" "$SUPERPOWERS_PLUGIN_FILE"

# Register plugin via symlink (what OpenCode actually reads)
mkdir -p "$OPENCODE_CONFIG_DIR/plugins"
ln -sf "$SUPERPOWERS_PLUGIN_FILE" "$OPENCODE_CONFIG_DIR/plugins/governed-superpowers.js"
...
echo "Governed-Superpowers dir:      $SUPERPOWERS_DIR"
echo "Skills dir:           $SUPERPOWERS_SKILLS_DIR"
echo "Plugin file:          $SUPERPOWERS_PLUGIN_FILE"
echo "Plugin registered at: $OPENCODE_CONFIG_DIR/plugins/governed-superpowers.js"

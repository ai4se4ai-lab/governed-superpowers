...
# and bundled governed-superpowers skills.
...
# Test 3: Test bundled governed-superpowers skill loading
echo ""
echo "Test 3: Testing native skill tool with a governed-superpowers skill..."

...
mkdir -p src test docs/governed-superpowers/plans

# Create a simple implementation plan
cat > docs/governed-superpowers/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/governed-superpowers/plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at docs/governed-superpowers/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"governed-superpowers:subagent-driven-development"' "$SESSION_FILE"; then
